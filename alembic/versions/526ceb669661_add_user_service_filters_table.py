...
def upgrade():
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["service_id"],
            ["services.id"],
            name=op.f("fk_users_services_filters_service_id_services"),
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_users_services_filters_user_id_users"),
        ),
        sa.PrimaryKeyConstraint(
            "user_id", "service_id", name=op.f("pk_users_services_filters")
        ),
    )
